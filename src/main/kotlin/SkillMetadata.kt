// Path: com/tbread/SkillMetadata.kt
package com.tbread
...
object SkillMetadata {
    ...
    val SKILL_MAP = mapOf(
        ...
        15200000 to "냉기 폭풍",
        15390000 to "불의 장벽",
        15390002 to "불의 장벽 - 잔불",
        15390008 to "불의 장벽 - 잔불 추가피해",
        15300000 to "루미엘의 공간",
        15300001 to "나락",
        15320007 to "지연 폭발",
        15120000 to "빙하 강타",
    ...
    val SKILL_CODES: IntArray = SKILL_MAP.keys.toIntArray().apply { sort() }

    fun inferOriginalSkillCode(skillCode: Int): Int? {
        // 1. 입력된 코드가 그대로 있는지 확인
